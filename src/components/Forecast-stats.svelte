        ...
        <div class="flex">
          <svg class="stat-icon" viewBox="0 0 16 28">
            ...
            <path
              ...
              3v12c-1.219 0.922-2 2.359-2 4 0 2.766 2.234 5 5 5s5-2.234 5-5zM14
              21c0 3.859-3.141 7-7 7s-7-3.141-7-7c0-1.906 0.766-3.625
              2-4.891v-11.109c0-2.766 2.234-5 5-5s5 2.234 5 5v11.109c1.234 1.266
              2 2.984 2 4.891zM16 12v2h-3v-2h3zM16 8v2h-3v-2h3zM16 4v2h-3v-2h3z" />
          </svg>
        ...
        <div class="flex">
          <svg class="stat-icon" viewBox="0 0 32 32">
            ...
            <path
              ...
              1.814-1.159 1.147-2.473 3.632-4.072 6.332-4.072 3.6 0 6.576 2.723
              6.924 6.334 0.123 1.432 0.123 1.432 1.615 1.773 2.586 0.494 4.461
              2.762 4.461 5.391 0 3.033-2.467 5.5-5.5 5.5z" />
          </svg>
        ...
        <div class="flex">
          <svg class="stat-icon" viewBox="0 0 24 24">
            ...
            <path
              ...
              6.363c1.756 1.755 4.059 2.633 6.358 2.634 2.308-0.001 4.613-0.881
              6.37-2.638 1.755-1.756 2.633-4.059
          ...
          {#if activeForecast.rain || !(activeForecast.rain || activeForecast.snow)}
            <svg class="stat-icon" viewBox="0 0 32 32">
              ...
              <path
                ...
                0.917-2.871 0.917-2.762 0-5-2.238-5-5s2.238-5 5-5c0.676 0 1.316
                0.138 1.902 0.38 1.327-2.588 3.991-4.38 7.098-4.38s5.771 1.792
                7.096 4.38c0.587-0.242 1.229-0.38 1.904-0.38 2.762 0 5 2.238 5
                5s-2.238 5-5 5zM14.063 30c0 1.105 0.895 2 2 2s2-0.895
          ...
          {#if activeForecast.snow}
            <svg class="stat-icon" viewBox="0 0 32 32">
              ...
              <path
                ...
                0.352 0.117 0.71 0.464 0.805l0.75 0.202c0.021 0.236 0.081 0.466
                0.186 0.685l-0.551 0.551c-0.255 0.256-0.254 0.671 0.003 0.926
                0.255 0.255 0.669 0.258 0.924 0.003l0.552-0.552c0.216 0.107
                0.448 0.167 0.688 0.185l0.198 0.751c0.096 0.35 0.453 0.559 0.805
                0.465 0.349-0.094 0.56-0.453
                ...
                0.805 0.095 0.349 0.454 0.555 0.806 0.464l0.742-0.202c0.066 0.1
                0.141 0.194 0.231 0.281 0.086 0.086 0.18 0.163 0.277
                0.227l-0.199 0.744c-0.094 0.352 0.115 0.714 0.463 0.807 0.352
                0.094 0.708-0.115 0.802-0.465l0.203-0.75c0.238-0.020 0.469-0.079
                0.688-0.184l0.549 0.549c0.255 0.258 0.669 0.253 0.927-0.003
                0.254-0.254 0.258-0.669 0-0.926l-0.551-0.551c0.106-0.216
                0.168-0.449 0.184-0.688l0.754-0.199c0.348-0.095 0.556-0.453
                ...
                0.917-2.762 0-5-2.238-5-5s2.238-5 5-5c0.676 0 1.316 0.138 1.902
                0.38 1.327-2.588 3.991-4.38 7.098-4.38s5.771 1.792 7.096
      ...
      <td>
        <div class="flex">
          <svg class="stat-icon" viewBox="0 0 24 24">
            <title>wind</title>
            <path
              d="M22.5 10.5c0-1.657-1.347-3-3-3-1.657 0-3 1.342-3 3h1.5c0-0.828
              0.666-1.5 1.5-1.5 0.828 0 1.5 0.666 1.5 1.5 0 0.828-0.667
              1.5-1.503 1.5h-17.247v1.5h17.251c1.656 0 2.999-1.347
